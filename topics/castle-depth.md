...
When adding stairs, make sure that it goes somewhere instead of a dead end. You never want a defender to run to the stairs only to get cornered because the stairs is a dead end.

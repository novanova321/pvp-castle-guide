# Complete V Rising PvP Castle Guide

## Introduction

This is my way of sharing the things I'm passionate about. Since I'm frequently asked about topics like these, I figured it would be easier to write everything down and simply share the link whenever needed. It also serves as a personal knowledge base, ensuring that important details and insights aren't lost over time.
...
- [Doors](topics/doors.md)
- [Floors](topics/floors.md)
- [Castle Depth](topics/castle-depth.md)
- [Starter Castle](topics/starter-castle.md)

## Plots

- [Analysis On All 146 Plots](topics/146-plots-analysis.md)
- [Plot Rankings and Recommendations](topics/plot-rankings-recommendations.md)

## Ground Level

- [Entrance Designs](topics/entrance-designs.md)
- [Castle Defenses (Servants, Banshees, Stygian Circle, etc..)](topics/castle-defenses.md)
- [Honeycomb](topics/honeycomb.md)
- [Castle Heart Design](topics/castle-heart-design.md)
- [Garden\*](topics/garden.md)

## Upper Floors

- [Snake Maze](topics/snake-maze.md)
- [Main Floor](topics/main-floor.md)
